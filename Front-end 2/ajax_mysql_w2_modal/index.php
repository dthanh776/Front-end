...
// $searchProduct = $productModel->searchProducts($keyword);
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="d-flex">
          <input onkeyup="showResult(productName)" class="form-control me-2" type="search" placeholder="Search" aria-label="Search">
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="row">
          ...
          ?>
            <div class="col-md-4">
              <a data-bs-toggle="modal" data-bs-target="#result" onclick="getProductDetail(<?php echo $item['id'] ?>)"><img src="./public/images/<?php echo $item['product_photo']; ?>" alt="" class="img-fluid"></a>
  ...
  <script src="./public/js/ajaxm.js"></script>
